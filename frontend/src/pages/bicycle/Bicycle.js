...
function Bicycle() {
    ...
    const addTrackGeo = async () => {
        try {
            ...
            await axios.post('https://smart-road.vercel.app/api/tracks', data);
    ...
    useEffect(() => {
        ...
        const checkStatus = async () => {
            try {
                const response = await axios.get(`https://smart-road.vercel.app/api/tracks?Vehicle_UID=${lastVehicleId}&_limit=1&_sort=createdAt:desc`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const response = await axios.get('https://smart-road.vercel.app/api/vehicles');
